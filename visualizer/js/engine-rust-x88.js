...
async function init() {
    try {
        ...
        board = new wasm_bindgen.RustBoard();
        ...
        postMessage("info string Rust x88 Engine initialized");
    } catch (e) {
...
onmessage = function (e) {
    ...
    switch (command) {
        ...
        case 'perft':
            ...
            if (!board) {
                postMessage('info string Error: Board not loaded');
                return;
            }
